...
enum class ExerciseCategoriesVol(val num: Int, val str: String) {
    CHEST(1, "가슴"),
    BACK(2, "등"),
    SHOULDER(3, "어깨"),
    LEG(4, "하체"),
...
// 드롭다운에 노출할 ‘불러오기용 루틴’ 모델
data class ImportRoutine(
    val routineId: String,
    val name: String,
    val items: List<RoutineExerciseWithSets>
)

data class DayRecordDetail(
    val record: ExerciseDayRecordModel,
    val items: List<RoutineExerciseWithSets>
)